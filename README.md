...
Later, I decided to allow the creation of multiple Game objects and adapted the code accordingly in the **MULTIPLE-GAMES** version. Despite these architectural differences, the features of the game remain unchanged across both versions.
