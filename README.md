...
Interactive TicTacToe game supporting multiple players. I used it as a learning project and updated it every time I learned new Python features. I started with #NORMAL #CLASSES (including inheritance and composition), then moved on to DATA CLASSES.
